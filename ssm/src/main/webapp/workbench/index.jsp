...
<body>
	...
	<div id="top" style="height: 50px; background-color: #3C3C3C; width: 100%;">
		<div style="position: absolute; top: 5px; left: 0; font-size: 30px; font-weight: 400; color: white; font-family: 'times new roman'">SSM &nbsp;<span style="font-size: 12px;">&copy;2021&nbsp;动力节点原创</span></div>
		<div style="position: absolute; top: 15px; right: 15px;" id="settings">
			<ul>
