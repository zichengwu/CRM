...
<%@ page import="com.cheng.ssm.workbench.domain.Tran" %>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.code === 100) {
                            ...
                            $("#editBy").html(editBy + "&nbsp;&nbsp;&nbsp;");
                            $("#editTime").html(data.extend.tran.editTime);
        ...
        function changeIcon(stage, index) {
            ...
            if ("0" === possibility) {
                ...
                for (let i = 0; i < point; i++) {
                    ...
                    ele1.removeClass();
                    //添加新的样式
                    ele1.addClass("glyphicon glyphicon-record mystage");
                    // 添加新的颜色
                    ele1.css("color", "#000000");
                }
                ...
                for (let i = 0; i < point; i++) {
                    ...
                    if (i < index) {
                        //添加新的样式
                        ele2.addClass("glyphicon glyphicon-ok-circle mystage");
                        // 添加新的颜色
                        ele2.css("color", "#90F790");
                        // 当前阶段之后为黑圈
                    } else if (i > index) {
                        //添加新的样式
                        ele2.addClass("glyphicon glyphicon-record mystage");
                        // 添加新的颜色
                        ele2.css("color", "#000000");
                        // 当前阶段为绿箭头
                    } else {
                        //添加新的样式
                        ele2.addClass("glyphicon glyphicon-map-marker mystage");
                        // 添加新的颜色
                        ele2.css("color", "#90F790");
                    }
                }
...
<div style="position: relative; left: 40px; top: -50px;">
    ...
    <span id="<%=i%>" onclick="changeStage('<%=stage%>' , '<%=i%>')" class="glyphicon glyphicon-remove mystage"
          style="color:#FF0000;" data-toggle="popover" data-placement="bottom" data-content="<%=stage%>"></span>
    -----------
    <%
                    } else {
    %>
    ...
    <span id="<%=i%>" onclick="changeStage('<%=stage%>' , '<%=i%>')" class="glyphicon glyphicon-ok-circle mystage"
          data-toggle="popover" data-placement="bottom" data-content="<%=stage%>" style="color: #90F790;"></span>
    -----------
...
<div style="position: relative; top: 0;">
    ...
    <div style="position: relative; left: 40px; height: 30px; top: 10px;">
        ...
        <div style="width: 300px;position: relative; left: 200px; top: -20px;">
            <b>${tran.customerId}-${requestScope.tran.name}</b></div>
